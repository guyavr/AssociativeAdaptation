...
plotMeanTimeCourse_Differential(ha_timecourse,t_wash)

co_afCSm= [121,161,197]/255; % blue
co_afCSp= 0.6*co_afCSm; % darker color
col=[co_afCSm;co_afCSp];
% Bar plots- summary analysis - Change in Hand Angle (Figs. 1C, 1D)
plotBarsMeanDiffHandAngle_Differential(Conditioning.dHA.adapt,t_n1,col)
plotBarsMeanDiffHandAngle_Differential(Conditioning.dHA.wash,t_n1,col)
