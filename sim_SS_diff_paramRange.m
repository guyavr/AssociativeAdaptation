%% simulate rescorla state-space (Fig. S2)
    ...
    for a=1:nParamRange
        ...
        for b=1:nParamRange
            ...
            for sim = 1:nsims
                ...
                us = [Shuffle(tmp_us) zeros(1,ntrials-length(tmp_us))]; % clamp trials (after shuffling, with 200 washouts)
                ...
                % learning
                tpt=[];tpl=[];lpt=[];lpl=[];
                for n = 101:nlearning %SHOULD BE FROM TRIAL 1??
